...
#' means_check_flat_depreciated
#' @description means_check_flat_depreciated
#' @export
means_check_flat_depreciated <- function(df, vars){
...
#' means_check_single_categorical_depreciated
#' @description means_check_single_categorical_depreciated
#' @export
means_check_single_categorical_depreciated <- function(df, var){
...
#' means_check_by_dictionary_depreciated
#' @description means_check_by_dictionary_depreciated
#' @export
means_check_by_dictionary_depreciated <- function(df, ...){
